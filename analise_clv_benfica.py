...
# Função para formatar valores com separador K
...
axes[0].set_xlabel('Número de Clusters (K)', fontsize=16, fontweight='bold')
axes[0].set_ylabel('WCSS (Within-Cluster Sum of Squares)', fontsize=16, fontweight='bold')
axes[0].set_title('Método Elbow', fontsize=18, fontweight='bold')
...
axes[1].set_xlabel('Número de Clusters (K)', fontsize=16, fontweight='bold')
axes[1].set_ylabel('Silhouette Score', fontsize=16, fontweight='bold')
axes[1].set_title('Silhouette Score por K', fontsize=18, fontweight='bold')
...
ax = sns.boxplot(data=df, x='Cluster_Name', y='CLV_Historico', order=order, palette='viridis')
...
plt.ylabel('CLV Histórico (€)', fontsize=18, fontweight='bold')
plt.title('RFM Global vs CLV por Cluster', fontsize=20, fontweight='bold')
plt.xticks(fontsize=16)
plt.yticks(fontsize=16)
ax.yaxis.set_major_formatter(FuncFormatter(thousands_formatter))
plt.tight_layout()
...
plt.title('Distribuição de Sócios por Cluster', fontsize=20, fontweight='bold')
plt.tight_layout()
